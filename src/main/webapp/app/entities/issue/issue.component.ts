...
export class IssueComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        if (this.currentSearch) {
            this.issueService
                ...
                .subscribe(
                    (res: HttpResponse<IIssue[]>) => this.paginateIssues(res.body, res.headers),
    ...
    trackId(index: number, item: IIssue) {
        return item.id;
    }
    ...
    private paginateIssues(data: IIssue[], headers: HttpHeaders) {
